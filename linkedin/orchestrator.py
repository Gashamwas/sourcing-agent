...
from linkedin.run_report import (
    ...
    bias_summary_for_report,
    finalize_linkedin_run_snapshot,
    generate_run_report,
    load_run_report_decisions,
)
...
Provide a narrowed Boolean."""
    ...
    def _bias_summary_for_report(self) -> str:
        return bias_summary_for_report(self._bias_monitor)
    ...
    def _load_run_report_decisions(
        ...
        return load_run_report_decisions(self.final_path, decision_filter, limit=limit)
