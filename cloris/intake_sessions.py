...
Per ``/Users/sam.vangelos/.claude/plans/ancient-plotting-lemon.md`` A1: the
...
The schema lives in :func:`shared.runtime_state.store.RuntimeStateStore._migrate`
under the ``intake_sessions`` CREATE TABLE; this module assumes the table
exists and only deals with row-level operations.
"""
