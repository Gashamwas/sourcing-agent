...
- LinkedIn: `python3 linkedin/session_orchestrator.py --brief ... --resume`
...
- any lingering pending candidate side effects are marked failed/interrupted
- projections are rebuilt if reconciliation changed durable state
