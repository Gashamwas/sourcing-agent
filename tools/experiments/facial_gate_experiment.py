...
prompt, edit ``linkedin/judgment_templates.py`` separately under the
normal review process.

Hard guarantees:

- No edits to ``linkedin/judgment_templates.py``, ``shared/judger.py``,
...
# ``linkedin/judgment_templates.py:FACIAL_TRIAGE_TEMPLATE``. If the template
