...
class SharedExecutionRuntime:
    ...
    def _build_stage_payload(
        *,
        ...
        if envelope.snippet is not None:
            payload["snippet"] = SharedExecutionRuntime._to_payload_dict(envelope.snippet)
        payload.update(extra_payload or {})
        if profile_summary is not None:
            payload["profile_summary"] = SharedExecutionRuntime._to_payload_dict(profile_summary)
        return payload
